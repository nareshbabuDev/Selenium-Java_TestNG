...
public class DemographicsUpdate extends DriverInitialize{

	String UserID,Url;
	String PatientID=null;
	//String Address1 =fake.address().streetAddress();;
	@BeforeTest(alwaysRun = true)
	public void setData() {
		testcaseName="Basic Login Verification";
	...
	public void DG001_Demographics_AddressUpdate(Map<String,String> map) throws Exception {	
		LoginPage lp = new LoginPage(driver, test);
		ModifyPatientPage mp = new ModifyPatientPage(driver, test);
		lp.HomePageVerification(UserID);
//	    mp.Address1_modify(PatientID);
